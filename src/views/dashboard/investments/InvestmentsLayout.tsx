...
const TABS: { label: string; to: string; icon: LucideIcon }[] = [
  { label: 'Overview', to: '/dashboard/investments/overview', icon: LayoutDashboard },
  { label: 'Property', to: '/dashboard/investments/property', icon: Home },
  { label: 'Stocks', to: '/dashboard/investments/stocks', icon: TrendingUp },
  { label: 'Ledger', to: '/dashboard/investments/ledger', icon: BookOpen },
  { label: 'Compliances', to: '/dashboard/investments/compliances', icon: CalendarCheck },
];
