...
const TABS: { label: string; to: string; icon: LucideIcon }[] = [
  { label: 'Overview', to: '/professional/investments/overview', icon: LayoutDashboard },
  { label: 'Property', to: '/professional/investments/property', icon: Home },
  { label: 'Stocks', to: '/professional/investments/stocks', icon: TrendingUp },
  { label: 'Ledger', to: '/professional/investments/ledger', icon: BookOpen },
  { label: 'Compliances', to: '/professional/investments/compliances', icon: CalendarCheck },
];

export function ProfessionalInvestmentsLayout({ children }: { children: ReactNode }) {
  return (
